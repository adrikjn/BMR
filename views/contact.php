<div class="container border d-flex flex-column align-items-center bg-white mt-3 p-1" style="border: 2px solid #ccc; border-radius: 10px; padding: 10px;">
        ...
        <form action="" method="">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control bg-light" id="email" placeholder="nom@exemple.com">
                        <label class="fw-bold"  for="email">Adresse email :</label>
                      </div>
                </div>
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="tel" name="tel" id="tel" placeholder="+33 X-XX-XX-XX-XX" class="form-control bg-light">
            ...
            <div class="form-floating mt-5 mb-5">
                <select class="form-select bg-light" id="besoin" aria-label="Floating label select example">
