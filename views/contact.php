<div class="container border d-flex flex-column align-items-center bg-white mt-3 p-1" style="border: 2px solid #ccc; border-radius: 10px; padding: 10px;">
        ...
        <form action="lib/traitement.php" method="POST">
            ...
            <div class="form-floating mt-3">
                <input type="text" class="form-control bg-light" id="name" placeholder="Prénom NOM" name="name">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control bg-light" id="email" placeholder="nom@exemple.com" name="email">
                        <label class="fw-bold"  for="email">Adresse email :</label>
                      </div>
                </div>
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="tel" name="tel" id="tel" placeholder="+33 X-XX-XX-XX-XX" class="form-control bg-light" name="tel">
            ...
            <div class="form-floating mt-5 mb-5">
                <select class="form-select bg-light" id="besoin" aria-label="Floating label select example" name="besoin">
              ...
              <div class="form-floating mb-5 mt-5">
                <textarea class="form-control bg-light" placeholder="Leave a comment here" id="message" style="height: 100px" name="message"></textarea>
